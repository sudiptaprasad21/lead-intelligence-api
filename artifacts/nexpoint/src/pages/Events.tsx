...
import { Check, Mail, Phone, ArrowRight, Play } from "lucide-react";
      ...
      <section className="py-24 px-4 container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <Card className="overflow-hidden border-0 shadow-lg group cursor-pointer h-full hover-elevate">
              ...
              <CardHeader>
                ...
                <CardTitle className="text-xl group-hover:text-primary transition-colors">Ep 12: The AI Marketing Revolution</CardTitle>
                <CardDescription className="text-base text-foreground/80">Guest: Dr. Rachel Kim, AI Research Lead at Stanford</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">How AI is fundamentally transforming digital marketing measurement and attribution.</p>
              </CardContent>
            </Card>
          </motion.div>
          ...
          >
            <Card className="overflow-hidden border-0 shadow-lg group cursor-pointer h-full hover-elevate">
              ...
              <CardHeader>
                ...
                <CardTitle className="text-xl group-hover:text-primary transition-colors">Ep 11: From 12 Tools to 1: A CMO Journey</CardTitle>
                <CardDescription className="text-base text-foreground/80">Guest: Michael Torres, CMO @ Apex Digital</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">How consolidating the marketing stack with Nexpoint reduced our budget by 35% and tripled team output.</p>
              </CardContent>
            </Card>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-muted-foreground mb-8">
                ...
                <p>
                  Join 500+ marketing leaders, CMOs, and growth professionals for 2 days of AI marketing deep-dives, live platform demos, hands-on workshops, and unparalleled networking.
                </p>
                <p>
                  Discover how leading enterprises are unifying their marketing stacks with Nexpoint to drive measurable, scalable growth.
                </p>
              </div>
                ...
                <CardContent>
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                      ...
                      <Button type="submit" className="w-full mt-6 py-6 text-lg" size="lg">
                        Apply for My Seat <ArrowRight className="ml-2 h-5 w-5" />
                      </Button>
